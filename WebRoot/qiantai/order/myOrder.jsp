...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        function pingjia(){  
	             //alert("asd");
                 window.location.href="qiantai/order/orderpingjia.jsp";  
        } 
    </script>
	</head>
								  ...
								  <tr align='center' bgcolor="#FFFFFF" height="22">
									  ...
									  <td>
									      ...
									      <s:if test="#order.orderZhuangtai=='yes'">
									        <input type="button" value="订单评价" onclick="pingjia()" style="border:#ccc 1px solid; background-color:#FFFFFF; font-size:12px; padding-top:3px;" />
									      </s:if>
		                              </td>
									  <td>
